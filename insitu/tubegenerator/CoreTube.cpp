...
extern "C" const char color_vert[];
extern "C" const char color_frag[];
extern "C" const char normal_vert[];
extern "C" const char normal_frag[];
extern "C" const char scalar0_vert[];
extern "C" const char scalar0_frag[];
extern "C" const char scalar1_vert[];
extern "C" const char scalar1_frag[];
extern "C" const char scalar2_vert[];
extern "C" const char scalar2_frag[];
...
{
    VertShader[0] = readShader(GL_VERTEX_SHADER, color_vert);
    FragShader[0] = readShader(GL_FRAGMENT_SHADER, color_frag);
    ...
    VertShader[1] = readShader(GL_VERTEX_SHADER, normal_vert);
    FragShader[1] = readShader(GL_FRAGMENT_SHADER, normal_frag);
    ...
    VertShader[2] = readShader(GL_VERTEX_SHADER, scalar0_vert);
    FragShader[2] = readShader(GL_FRAGMENT_SHADER, scalar0_frag);
    ...
    VertShader[3] = readShader(GL_VERTEX_SHADER, scalar1_vert);
    FragShader[3] = readShader(GL_FRAGMENT_SHADER, scalar1_frag);
    ...
    VertShader[4] = readShader(GL_VERTEX_SHADER, scalar2_vert);
    FragShader[4] = readShader(GL_FRAGMENT_SHADER, scalar2_frag);
...
GLuint CoreTube::readShader(GLenum shader_type, const char source[])
{
