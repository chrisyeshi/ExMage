...
void TFColorMapArea::paintEvent(QPaintEvent *e)
{
...
void TFDrawArea::paintEvent(QPaintEvent *e)
{
    QPainter painter(this);
...
void TFColorControlArea::leaveEvent(QEvent *e)
{
...
void TFColorControlArea::mouseReleaseEvent(QMouseEvent *e)
{
    if (_draggedControl >= 0)
        _draggedControl = -1;
}

void TFColorControlArea::paintEvent(QPaintEvent *e)
{
    QPainter painter(this);
    painter.setRenderHint(QPainter::Antialiasing, true);
